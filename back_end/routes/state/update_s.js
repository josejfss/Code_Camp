...
module.exports = (express,app) => {
	...
	app.post('/update_state', checkAuth, check_role_auth(2), upload.any(), async function(req,res){
        const { 
            id_estado,
            nombre
         } = req.body;
        ...
        try {
			...
			const state = await sequelize.query(`EXEC update_estado ${id_estado}, '${nombre}'`);
